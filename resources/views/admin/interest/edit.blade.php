                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Edit Interest</h4>
                        ...
                        <div class="widget-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="/admin/interest/editinterest" class="form-horizontal" method="post">
                                {!! csrf_field() !!}
                                <div class="control-group">
                                    <label class="control-label">Interest Name</label>
                                    <div class="controls">
                                        <input type="text" name="interest_name" id="interest_name" placeholder="Interest name" class="input-large" value="{{ $interest->interest_name }}" tabindex="1" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="input-small m-wrap" tabindex="2" name="status" id="status">
                                            <option value="1" <?=$interest->status==1?"selected":""?>>Active</option>
                                            <option value="0" <?=$interest->status==0?"selected":""?>>In-Active</option>
                                        </select>
                                    </div>
                                </div>
                                <input type="hidden" name="hdintrestid" id="hdintrestid" value="{{ $interest->interest_id }}" />
